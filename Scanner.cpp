...
void Scanner::Init() {
	...
	keywords.set(L"endl", 9);
	keywords.set(L"del", 10);
	keywords.set(L"var", 11);
	keywords.set(L"bool", 12);
	keywords.set(L"int", 13);
	keywords.set(L"float", 14);
	keywords.set(L"if", 19);
	keywords.set(L"elif", 22);
	keywords.set(L"else", 23);
	keywords.set(L"while", 24);
	keywords.set(L"for", 25);
	keywords.set(L"or", 26);
	keywords.set(L"and", 27);
	keywords.set(L"not", 37);
	keywords.set(L"true", 44);
	keywords.set(L"True", 45);
	keywords.set(L"false", 46);
	keywords.set(L"False", 47);
	keywords.set(L"Print", 48);
	keywords.set(L"Println", 49);
